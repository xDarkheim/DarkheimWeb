<div class="page-container home-page-container">
    <section class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">Darkheim Universe</h1>
    ...
    <section class="home-section call-to-action">
        ...
        <div class="cta-actions">
            <a href="/index.php?page=register" class="button button-primary button-large">Register</a>
            <a href="/index.php?page=login" class="button button-secondary button-large">Login</a>
        </div>
    </section>
    <?php endif; ?>
</div>